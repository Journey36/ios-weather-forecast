...
프로젝트 기간이 지난 후 완성하지 못한 내용을 추가 진행 하여 완성한 내용을 정리했다.

### 코드로만 UI 구현

- 스토리보드 삭제 
    - [참고](https://velog.io/@minni/Storyboard-%EC%97%86%EC%9D%B4-%EC%BD%94%EB%93%9C%EB%A1%9C-view-%EC%9E%91%EC%84%B1%ED%95%98%EA%B8%B0)
